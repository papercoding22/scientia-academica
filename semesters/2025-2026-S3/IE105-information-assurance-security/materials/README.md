...
|---|---|---|
| [`syllabus/`](syllabus/) | Đề cương môn học, kế hoạch giảng dạy | `de-cuong-IE105.pdf` |
...
Bỏ đề cương vào đây rồi bảo AI: *"đọc đề cương IE105, điền IMPORTANT_NOTES"*.

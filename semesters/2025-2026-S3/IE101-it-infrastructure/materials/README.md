...
|---|---|---|
| [`syllabus/`](syllabus/) | Đề cương môn học, kế hoạch giảng dạy | `de-cuong-IE101.pdf` |
...
Bỏ đề cương vào đây rồi bảo AI: *"đọc đề cương IE101, điền IMPORTANT_NOTES"*.

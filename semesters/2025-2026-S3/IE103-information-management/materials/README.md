...
|---|---|---|
| [`syllabus/`](syllabus/) | Đề cương môn học, kế hoạch giảng dạy | `de-cuong-IE103.pdf` |
...
Bỏ đề cương vào đây rồi bảo AI: *"đọc đề cương IE103, điền IMPORTANT_NOTES"*.

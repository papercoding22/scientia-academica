...
| | |
|---|---|
| Mã lớp | `IE106.G11.CN1.CNTT` |
| Tên tiếng Anh (tạm dịch) | User Interface Design |
| Giảng viên | **❓ chưa xác nhận** |
| Số tín chỉ | **4 TC** |
| Học kỳ | HK1 2026–2027 |
| Trạng thái | ⬜ sắp học |
| Hình thức | Online qua Microsoft Teams |

> **Nguồn mã lớp, tên môn và tín chỉ:** [danh sách người dùng cung cấp ngày 2026-09-25](../README.md).
> Giảng viên chưa có thông tin; ghi `❓ chưa xác nhận` theo phản hồi của người dùng cùng ngày.
...
Dựa trên tên môn, trọng tâm dự kiến là tổ chức giao diện để người dùng hiểu và thực hiện được
công việc của họ. Điểm giao với **IE104 (Web)** là biến thiết kế thành ứng dụng sử dụng được;
với một dev đang đi làm, môn có thể giúp giải thích lý do đằng sau các quyết định bố cục và tương tác.

> Viết lúc khởi tạo, dựa trên tên môn. Sửa lại sau buổi học đầu tiên.
> ❓ Chưa có đề cương để xác nhận phương pháp, công cụ và bài tập của môn.

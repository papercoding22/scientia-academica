...
|---|---|---|
| [`syllabus/`](syllabus/) | Đề cương môn học, kế hoạch giảng dạy | `de-cuong-IE106.pdf` |
...
Bỏ đề cương vào đây rồi bảo AI: *"đọc đề cương IE106, điền IMPORTANT_NOTES"*.

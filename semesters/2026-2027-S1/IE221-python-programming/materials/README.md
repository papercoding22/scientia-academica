...
|---|---|---|
| [`syllabus/`](syllabus/) | Đề cương môn học, kế hoạch giảng dạy | `de-cuong-IE221.pdf` |
...
Bỏ đề cương vào đây rồi bảo AI: *"đọc đề cương IE221, điền IMPORTANT_NOTES"*.

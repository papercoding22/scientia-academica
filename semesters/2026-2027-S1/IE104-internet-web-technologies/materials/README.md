...
|---|---|---|
| [`syllabus/`](syllabus/) | Đề cương môn học, kế hoạch giảng dạy | `de-cuong-IE104.pdf` |
...
Bỏ đề cương vào đây rồi bảo AI: *"đọc đề cương IE104, điền IMPORTANT_NOTES"*.

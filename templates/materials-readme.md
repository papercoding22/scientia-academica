...
|---|---|---|
| [`syllabus/`](syllabus/) | Đề cương môn học, kế hoạch giảng dạy | `de-cuong-{{CODE}}.pdf` |
...
Bỏ đề cương vào đây rồi bảo AI: *"đọc đề cương {{CODE}}, điền IMPORTANT_NOTES"*.
